...
class Q {
  ...
  set lang(e) {
    this._lang = e, this.render();
  }
  render() {
    document.querySelectorAll("[data-locale]").forEach((e) => {
      const t = e.getAttribute("data-locale");
      e.innerText = c[t][this.lang] || "";
    });
  }
  unload() {
    Object.keys(c).forEach((e) => delete c[e]), l = 0;
  }
}
export {
  B as Button,
